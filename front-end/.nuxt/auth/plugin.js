...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/login","method":"post","propertyName":"token"},"logout":{"url":"/logout","method":"post"},"user":{"url":"/user","method":"get","propertyName":false}},"tokenRequired":true,"tokenType":"token","_name":"local"}))
